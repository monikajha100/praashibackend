...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 21, 2025 at 05:52 AM
...
CREATE TABLE `instagram_posts` (
  `id` int(11) NOT NULL,
  `instagram_id` varchar(255) DEFAULT NULL COMMENT 'Instagram post ID if synced',
  `caption` text DEFAULT NULL,
  `media_url` varchar(500) NOT NULL,
  `media_type` enum('IMAGE','VIDEO','CAROUSEL') DEFAULT 'IMAGE',
  ...
  `hashtags` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Array of hashtags used' CHECK (json_valid(`hashtags`)),
  `tagged_products` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin DEFAULT NULL COMMENT 'Array of product IDs with tag positions' CHECK (json_valid(`tagged_products`)),
  `is_shoppable` tinyint(1) DEFAULT 0,
  `campaign_id` int(11) DEFAULT NULL COMMENT 'Link to marketing campaign if applicable',
...
CREATE TABLE `orders` (
  ...
  `payment_method` enum('cash_on_delivery','credit_card','debit_card','net_banking','upi','wallet','razorpay') DEFAULT 'cash_on_delivery',
  `subtotal` decimal(10,2) NOT NULL DEFAULT 0.00,
  `tax_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `shipping_amount` decimal(10,2) NOT NULL DEFAULT 0.00,
  `currency` varchar(3) DEFAULT 'INR',
  ...
  `offer_id` int(11) DEFAULT NULL COMMENT 'Special offer ID if this order used a special offer'
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `orders` (`id`, `user_id`, `total_amount`, `payment_status`, `order_status`, `shipping_address`, `billing_address`, `created_at`, `updated_at`, `order_number`, `status`, `payment_method`, `subtotal`, `tax_amount`, `shipping_amount`, `currency`, `customer_name`, `customer_email`, `customer_phone`, `notes`, `tracking_number`, `shipped_at`, `delivered_at`, `razorpay_payment_id`, `razorpay_order_id`, `offer_id`) VALUES
(1, 3, 1353.90, 'paid', 'pending', '123 Main Street, Mumbai, Maharashtra 400001', '123 Main Street, Mumbai, Maharashtra 400001', '2025-10-04 03:07:15', '2025-10-04 16:40:28', 'ORD-2025-001', 'delivered', 'cash_on_delivery', 1105.00, 198.90, 50.00, 'INR', 'Test User', 'test@example.com', '+91 9876543210', 'Please deliver after 6 PM', 'TRK123456789', '2025-01-15 04:30:00', '2025-01-17 09:00:00', NULL, NULL, NULL),
(2, 3, 1319.68, 'paid', 'pending', '456 Park Avenue, Delhi, Delhi 110001', '456 Park Avenue, Delhi, Delhi 110001', '2025-10-04 03:07:15', '2025-10-04 16:40:28', 'ORD-2025-002', 'shipped', 'upi', 1076.00, 193.68, 50.00, 'INR', 'Test User', 'test@example.com', '+91 9876543210', 'Gift wrapping required', 'TRK987654321', '2025-01-20 03:30:00', NULL, NULL, NULL, NULL),
(3, 3, 907.86, 'paid', 'pending', '789 Garden Road, Bangalore, Karnataka 560001', '789 Garden Road, Bangalore, Karnataka 560001', '2025-10-04 03:07:15', '2025-10-04 16:40:28', 'ORD-2025-003', 'processing', 'credit_card', 727.00, 130.86, 50.00, 'INR', 'Test User', 'test@example.com', '+91 9876543210', 'Fragile items - handle with care', NULL, NULL, NULL, NULL, NULL, NULL),
(4, NULL, 1343.28, 'pending', 'pending', 'affaf', 'affaf', '2025-10-04 04:23:07', '2025-10-04 16:40:28', 'ORD-2025-787616', 'pending', '', 1096.00, 197.28, 50.00, 'INR', 'zvzv', 'zv@gmail.com', '6566554545', '', NULL, NULL, NULL, NULL, NULL, NULL),
(5, NULL, 461.82, 'pending', 'pending', 'hchdhdhhdhdhdhd', 'hchdhdhhdhdhdhd', '2025-10-04 04:28:26', '2025-10-04 16:40:28', 'ORD-2025-106661', 'pending', '', 349.00, 62.82, 50.00, 'INR', 'mvvm', 'faf@gmail.com', '4545656565', '', NULL, NULL, NULL, NULL, NULL, NULL),
(6, NULL, 1319.68, 'pending', 'pending', 'sagvsagdgaag', 'sagvsagdgaag', '2025-10-04 04:53:31', '2025-10-04 16:40:28', 'ORD-2025-611754', 'pending', '', 1076.00, 193.68, 50.00, 'INR', 'dvfgdg', 'dg@gmail.com', '3232525252', '', NULL, NULL, NULL, NULL, NULL, NULL),
(7, NULL, 1765.72, 'pending', 'pending', 'sggsgsgsgsgsgsg', 'sggsgsgsgsgsgsg', '2025-10-04 05:01:29', '2025-10-04 16:40:28', 'ORD-2025-089526', 'pending', '', 1454.00, 261.72, 50.00, 'INR', 'gkgfk', 'gkg@gmail.com', '6595956595', '', NULL, NULL, NULL, NULL, NULL, NULL),
(8, NULL, 873.64, 'pending', 'pending', 'dffbhfdshbfddbd', 'dffbhfdshbfddbd', '2025-10-04 05:07:10', '2025-10-04 16:40:28', 'ORD-2025-430418', 'pending', '', 698.00, 125.64, 50.00, 'INR', 'dgdg', 'dgd@gmail.com', '9879879879', '', NULL, NULL, NULL, NULL, NULL, NULL),
(9, NULL, 1530.90, 'pending', 'pending', 'afgafgagagaag', 'afgafgagagaag', '2025-10-04 05:09:41', '2025-10-04 16:40:28', 'ORD-2025-581632', 'pending', '', 1255.00, 225.90, 50.00, 'INR', 'sgsgs', 'sgsg@gmail.com', '6595695696', '', NULL, NULL, NULL, NULL, NULL, NULL),
(10, NULL, 1343.28, 'pending', 'pending', 'sbgvsgbsbgsbbsvbs', 'sbgvsgbsbgsbbsvbs', '2025-10-04 05:11:27', '2025-10-04 16:40:28', 'ORD-2025-687950', 'pending', '', 1096.00, 197.28, 50.00, 'INR', 'fjfjf', 'hsdh@gmail.com', '6565656565', '', NULL, NULL, NULL, NULL, NULL, NULL),
(11, NULL, 907.86, 'pending', 'pending', 'sgbsbbsbbsbssfb', 'sgbsbbsbbsbssfb', '2025-10-04 05:17:15', '2025-10-04 16:40:28', 'ORD-2025-035390', 'pending', '', 727.00, 130.86, 50.00, 'INR', 'nfgdnd', 'dndn@gmail.com', '6565465654', '', NULL, NULL, NULL, NULL, NULL, NULL),
(12, NULL, 696.64, 'pending', 'pending', 'Test Address, Test City', 'Test Address, Test City', '2025-10-04 05:27:01', '2025-10-04 16:40:28', 'ORD-2025-621687', 'pending', '', 548.00, 98.64, 50.00, 'INR', 'Test Customer', 'test@example.com', '9876543210', 'Test order for payment flow', NULL, NULL, NULL, NULL, NULL, NULL),
(13, NULL, 1353.90, 'paid', 'pending', 'Test Address, Test City', 'Test Address, Test City', '2025-10-04 05:27:22', '2025-10-04 16:40:28', 'ORD-2025-642325', 'pending', '', 1105.00, 198.90, 50.00, 'INR', 'Test Customer', 'test@example.com', '9876543210', 'Test order for payment flow', NULL, NULL, NULL, 'pay_test_1759555642650', 'order_1759555642647', NULL),
(14, NULL, 907.86, 'pending', 'pending', 'ujjdtttjttt', 'ujjdtttjttt', '2025-10-04 09:00:59', '2025-10-04 16:40:28', 'ORD-2025-459682', 'pending', '', 727.00, 130.86, 50.00, 'INR', 'ravi', 'rv@gmail.com', '9896669888', '', NULL, NULL, NULL, NULL, NULL, NULL),
(15, NULL, 696.64, 'pending', 'pending', 'ujjdtttjttt', 'ujjdtttjttt', '2025-10-04 09:01:07', '2025-10-04 16:40:28', 'ORD-2025-467837', 'pending', '', 548.00, 98.64, 50.00, 'INR', 'ravi', 'rv@gmail.com', '9896669888', '', NULL, NULL, NULL, NULL, NULL, NULL),
(16, NULL, 1554.50, 'pending', 'pending', 'ujjdtttjttt', 'ujjdtttjttt', '2025-10-04 09:01:23', '2025-10-04 16:40:28', 'ORD-2025-483241', 'pending', '', 1275.00, 229.50, 50.00, 'INR', 'ravi', 'rv@gmail.com', '9896669888', '', NULL, NULL, NULL, NULL, NULL, NULL),
(17, NULL, 1108.46, 'pending', 'pending', 'ujjdtttjttt', 'ujjdtttjttt', '2025-10-04 09:04:33', '2025-10-04 16:40:28', 'ORD-2025-673300', 'pending', '', 897.00, 161.46, 50.00, 'INR', 'ravi', 'rv@gmail.com', '9896669888', '', NULL, NULL, NULL, NULL, NULL, NULL),
(18, NULL, 1119.08, 'pending', 'pending', 'ujjdtttjttt', 'ujjdtttjttt', '2025-10-04 09:04:41', '2025-10-04 16:40:28', 'ORD-2025-681674', 'pending', '', 906.00, 163.08, 50.00, 'INR', 'ravi', 'rv@gmail.com', '9896669888', '', NULL, NULL, NULL, NULL, NULL, NULL),
(19, NULL, 1554.50, 'pending', 'pending', 'sfgfbfsgsggsg', 'sfgfbfsgsggsg', '2025-10-04 09:08:19', '2025-10-04 16:40:28', 'ORD-2025-899263', 'pending', '', 1275.00, 229.50, 50.00, 'INR', 'zxdbb', 'xvgx@gmail.com', '6565848484', '', NULL, NULL, NULL, NULL, NULL, NULL),
(20, NULL, 931.46, 'pending', 'pending', 'sagsaggsgs', 'sagsaggsgs', '2025-10-04 09:08:58', '2025-10-04 16:40:28', 'ORD-2025-938057', 'pending', '', 747.00, 134.46, 50.00, 'INR', 'mjfvm', 'fn@gmail.com', '6554788858', '', NULL, NULL, NULL, NULL, NULL, NULL),
(21, NULL, 461.82, 'pending', 'pending', 'dbdbedeebebebh', 'dbdbedeebebebh', '2025-10-04 09:11:04', '2025-10-04 16:40:28', 'ORD-2025-064657', 'pending', '', 349.00, 62.82, 50.00, 'INR', 'dnndcccs', 'bxb@gmail.com', '9696363633', '', NULL, NULL, NULL, NULL, NULL, NULL),
(22, NULL, 873.64, 'pending', 'pending', 'dbdbedeebebebh', 'dbdbedeebebebh', '2025-10-04 09:11:09', '2025-10-04 16:40:28', 'ORD-2025-069534', 'pending', '', 698.00, 125.64, 50.00, 'INR', 'dnndcccs', 'bxb@gmail.com', '9696363633', '', NULL, NULL, NULL, NULL, NULL, NULL),
(23, NULL, 1530.90, 'pending', 'pending', 'yryyysysy', 'yryyysysy', '2025-10-04 09:14:12', '2025-10-04 16:40:28', 'ORD-2025-252329', 'pending', '', 1255.00, 225.90, 50.00, 'INR', 'fjfjf', 'dhjdh@gmail.com', '2131213121', '', NULL, NULL, NULL, NULL, NULL, NULL),
(24, NULL, 1554.50, 'pending', 'pending', 'niniinininnin', 'njnkjjnnjnjnjnjjnnjn', '2025-10-04 09:17:39', '2025-10-04 16:40:28', 'ORD-2025-459850', 'pending', '', 1275.00, 229.50, 50.00, 'INR', 'njnun', 'bxb@gmail.com', '9696363633', '', NULL, NULL, NULL, NULL, NULL, NULL),
(25, NULL, 696.64, 'pending', 'pending', 'niniinininnin', 'njnkjjnnjnjnjnjjnnjn', '2025-10-04 09:17:45', '2025-10-04 16:40:28', 'ORD-2025-465281', 'pending', '', 548.00, 98.64, 50.00, 'INR', 'njnun', 'bxb@gmail.com', '9696363633', '', NULL, NULL, NULL, NULL, NULL, NULL),
(26, NULL, 461.82, 'pending', 'pending', 'sgsgggsgsgsgsg', 'sgsgggsgsgsgsg', '2025-10-04 09:25:45', '2025-10-04 16:40:28', 'ORD-2025-945990', 'pending', '', 349.00, 62.82, 50.00, 'INR', 'ndcnxfn', 'xh@gmail.com', '3252365252', '', NULL, NULL, NULL, NULL, NULL, NULL),
(27, NULL, 1119.08, 'pending', 'pending', 'sgsgggsgsgsgsg', 'sgsgggsgsgsgsg', '2025-10-04 09:25:51', '2025-10-04 16:40:28', 'ORD-2025-951141', 'pending', '', 906.00, 163.08, 50.00, 'INR', 'ndcnxfn', 'xh@gmail.com', '3252365252', '', NULL, NULL, NULL, NULL, NULL, NULL),
(28, NULL, 284.82, 'pending', 'pending', 'cfccncn', 'cfccncn', '2025-10-04 16:33:34', '2025-10-04 16:33:34', 'ORD-2025-614043', 'pending', '', 199.00, 35.82, 50.00, 'INR', 'tgfgh', 'dg@gmail.com', '6565665566', '', NULL, NULL, NULL, NULL, NULL, NULL),
(29, NULL, 168.00, 'pending', 'pending', 'wvfwvfwvvw', 'wvfwvfwvvw', '2025-10-05 05:24:40', '2025-10-05 05:24:40', 'ORD-2025-880552', 'pending', '', 100.00, 18.00, 50.00, 'INR', 'hjh', 'tnmt@gmail.com', '6565545454', '', NULL, NULL, NULL, NULL, NULL, NULL),
(30, NULL, 168.00, 'pending', 'pending', 'wvfwvfwvvw', 'wvfwvfwvvw', '2025-10-05 05:24:51', '2025-10-05 05:24:51', 'ORD-2025-891387', 'pending', '', 100.00, 18.00, 50.00, 'INR', 'hjh', 'tnmt@gmail.com', '6565545454', '', NULL, NULL, NULL, NULL, NULL, NULL),
(31, NULL, 261.22, 'paid', 'pending', 'vfgvdvvfvwsv', 'vfgvdvvfvwsv', '2025-10-05 05:26:54', '2025-10-05 05:26:55', 'ORD-2025-014286', 'pending', '', 179.00, 32.22, 50.00, 'INR', 'fnf', 'fbv@gmail.com', '6565545454', '', NULL, NULL, NULL, 'pay_demo_1759642015675', 'order_1759642014476', NULL),
(32, NULL, 461.82, 'paid', 'pending', 'dhdhdh', 'dhdhdh', '2025-10-05 05:35:36', '2025-10-05 05:35:40', 'ORD-2025-536285', 'pending', '', 349.00, 62.82, 50.00, 'INR', 'fnmfn', 'dndn@gmail.com', '6655665566', '', NULL, NULL, NULL, 'pay_demo_1759642540424', 'order_1759642536480', NULL),
(33, NULL, 933.82, 'paid', 'pending', 'avavvaav', 'avavvaav', '2025-10-05 12:35:51', '2025-10-05 12:35:55', 'ORD-2025-751823', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'dhbd', 'dbnd@gmail.com', '6565696633', '', NULL, NULL, NULL, 'pay_demo_1759667755599', 'order_1759667752761', NULL),
(34, NULL, 933.82, 'pending', 'pending', 'sdfgssbbb', 'sdfgssbbb', '2025-10-05 12:41:13', '2025-10-05 12:41:13', 'ORD-2025-073014', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'fjfj', 'fjfj@gmail.com', '3252362333', '', NULL, NULL, NULL, NULL, NULL, NULL),
(35, NULL, 933.82, 'pending', 'pending', 'sdfgssbbb', 'sdfgssbbb', '2025-10-05 12:43:05', '2025-10-05 12:43:05', 'ORD-2025-185041', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'fjfj', 'fjfj@gmail.com', '3252362333', '', NULL, NULL, NULL, NULL, NULL, NULL),
(36, NULL, 933.82, 'paid', 'pending', 'affafaffaf', 'affafaffaf', '2025-10-05 12:44:08', '2025-10-05 12:44:19', 'ORD-2025-248790', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'hbdfxhb', 'xb@gmail.com', '3636525252', '', NULL, NULL, NULL, 'pay_demo_1759668259902', 'order_1759668249354', NULL),
(37, NULL, 933.82, 'pending', 'pending', 'ffsvfsvsvsfvvssv', 'ffsvfsvsvsfvvssv', '2025-10-05 12:46:16', '2025-10-05 12:46:16', 'ORD-2025-376931', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'sfvsf', 'sf@gmail.com', '6333222255', '', NULL, NULL, NULL, NULL, NULL, NULL),
(38, NULL, 284.82, 'paid', 'pending', 'svbsvssvvsv', 'svbsvssvvsv', '2025-10-05 12:56:22', '2025-10-05 12:56:28', 'ORD-2025-982856', 'pending', '', 199.00, 35.82, 50.00, 'INR', 'bdbb', 'dbdb@gmail.com', '3322332222', '', NULL, NULL, NULL, 'pay_demo_1759668988122', 'order_1759668983012', NULL),
(39, NULL, 284.82, 'paid', 'pending', 'svvsvvsv', 'svvsvvsv', '2025-10-05 12:59:57', '2025-10-05 12:59:59', 'ORD-2025-197703', 'pending', '', 199.00, 35.82, 50.00, 'INR', 'bxb', 'vsvs@gmail.com', '1125255885', '', NULL, NULL, NULL, 'pay_demo_1759669199426', 'order_1759669197853', NULL),
(40, NULL, 284.82, 'pending', 'pending', 'ahmedabad', 'ahmedabad', '2025-10-05 13:07:34', '2025-10-05 13:07:34', 'ORD-2025-654437', 'pending', '', 199.00, 35.82, 50.00, 'INR', 'Addealindia', 'dbdb@gmail.com', '3322332222', '', NULL, NULL, NULL, NULL, NULL, NULL),
(41, NULL, 461.82, 'pending', 'pending', 'sgsggsggs', 'sgsggsggs', '2025-10-07 03:24:09', '2025-10-07 03:24:09', 'ORD-2025-449520', 'pending', '', 349.00, 62.82, 50.00, 'INR', 'djhdj', 'dj@gmail.com', '6565656565', '', NULL, NULL, NULL, NULL, NULL, NULL),
(42, NULL, 461.82, 'pending', 'pending', 'Test Address, Test City', 'Test Address, Test City', '2025-10-07 04:55:17', '2025-10-07 04:55:17', 'ORD-2025-917457', 'pending', '', 349.00, 62.82, 50.00, 'INR', 'Test Customer', 'test@example.com', '9876543210', 'Test order', NULL, NULL, NULL, NULL, NULL, NULL),
(43, NULL, 166.82, 'pending', 'pending', 'lghlhhhh.hgjhhg', 'lghlhhhh.hgjhhg', '2025-10-07 05:20:19', '2025-10-07 05:20:19', 'ORD-2025-419201', 'pending', '', 99.00, 17.82, 50.00, 'INR', 'fjf', 'fjf@gmail.com', '3252365252', '', NULL, NULL, NULL, NULL, NULL, NULL),
(44, NULL, 166.82, 'pending', 'pending', 'dndndddndndn', 'dndndddndndn', '2025-10-07 05:22:20', '2025-10-07 05:22:20', 'ORD-2025-540109', 'pending', '', 99.00, 17.82, 50.00, 'INR', 'nfn', 'dndn@gmail.com', '3232322332', '', NULL, NULL, NULL, NULL, NULL, NULL),
(45, NULL, 343.82, 'pending', 'pending', 'dfndndgndnnnd', 'dfndndgndnnnd', '2025-10-07 05:32:01', '2025-10-07 05:32:01', 'ORD-2025-121945', 'pending', '', 249.00, 44.82, 50.00, 'INR', 'ddgg', 'ravi@gmail.com', '6565696969', '', NULL, NULL, NULL, NULL, NULL, NULL),
(46, NULL, 933.82, 'pending', 'pending', 'nfgnfn', 'nfgnfn', '2025-10-11 03:16:15', '2025-10-11 03:16:15', 'ORD-2025-575536', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'ccbnnc', 'xb@gmail.com', '6556569696', '', NULL, NULL, NULL, NULL, NULL, NULL),
(47, NULL, 933.82, 'pending', 'pending', 'nfgnfn', 'nfgnfn', '2025-10-11 03:18:34', '2025-10-11 03:18:34', 'ORD-2025-714498', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'ccbnnc', 'xb@gmail.com', '6556569696', '', NULL, NULL, NULL, NULL, NULL, NULL),
(48, NULL, 933.82, 'pending', 'pending', 'bhddfhdhhb', 'bhddfhdhhb', '2025-10-11 03:22:41', '2025-10-11 03:22:41', 'ORD-2025-961111', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'cmn', 'cn@gmail.com', '5656555855', '', NULL, NULL, NULL, NULL, NULL, NULL),
(49, NULL, 933.82, 'pending', 'pending', 'bhddfhdhhb', 'bhddfhdhhb', '2025-10-11 03:24:19', '2025-10-11 03:24:19', 'ORD-2025-059407', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'cmn', 'cn@gmail.com', '5656555855', '', NULL, NULL, NULL, NULL, NULL, NULL),
(50, NULL, 933.82, 'pending', 'pending', 'bhddfhdhhb', 'bhddfhdhhb', '2025-10-11 03:24:27', '2025-10-11 03:24:27', 'ORD-2025-067551', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'cmn', 'cn@gmail.com', '5656555855', '', NULL, NULL, NULL, NULL, NULL, NULL),
(51, NULL, 933.82, 'pending', 'pending', 'bhddfhdhhb', 'bhddfhdhhb', '2025-10-11 03:24:39', '2025-10-11 03:24:39', 'ORD-2025-079036', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'cmn', 'cn@gmail.com', '5656555855', '', NULL, NULL, NULL, NULL, NULL, NULL),
(52, NULL, 933.82, 'pending', 'pending', 'bhddfhdhhb', 'bhddfhdhhb', '2025-10-11 03:26:11', '2025-10-11 03:26:11', 'ORD-2025-171100', 'pending', '', 749.00, 134.82, 50.00, 'INR', 'cmn', 'cn@gmail.com', '5656555855', '', NULL, NULL, NULL, NULL, NULL, NULL),
(53, NULL, 286.00, 'pending', 'pending', 'swggsfggsdfg', 'swggsfggsdfg', '2025-10-11 03:28:38', '2025-10-11 03:28:38', 'ORD-2025-318399', 'pending', '', 200.00, 36.00, 50.00, 'INR', 'wetetet', 'etet@gmail.com', '6565658585', '', NULL, NULL, NULL, NULL, NULL, NULL),
(54, NULL, 2358.82, 'pending', 'pending', 'bdbdbbdbdddd', 'bdbdbbdbdddd', '2025-10-11 05:22:30', '2025-10-11 05:22:30', 'ORD-2025-150542', 'pending', '', 1999.00, 359.82, 0.00, 'INR', 'Ravi', 'rtr@gmail.com', '6969666333', '', NULL, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `order_items` (
  ...
  `discounted_quantity` int(11) DEFAULT NULL COMMENT 'Number of units that received discount',
  `discount_per_unit` decimal(10,2) DEFAULT NULL COMMENT 'Discount amount per unit',
  `discount_percentage` decimal(5,2) DEFAULT NULL COMMENT 'Discount percentage applied (e.g., 50 for 50% off)',
  `quantity` int(11) NOT NULL,
...
INSERT INTO `order_items` (`id`, `order_id`, `product_id`, `product_name`, `product_price`, `discounted_quantity`, `discount_per_unit`, `discount_percentage`, `quantity`, `total_price`, `created_at`, `product_image`, `product_sku`, `updated_at`) VALUES
(33, 28, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:33:34', NULL, NULL, '2025-10-04 16:33:34'),
(34, 1, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(35, 1, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(36, 1, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(37, 2, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(38, 2, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(39, 2, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(40, 3, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(41, 3, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(42, 3, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(43, 4, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(44, 4, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(45, 5, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(46, 6, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(47, 6, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(48, 6, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(49, 7, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(50, 7, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(51, 7, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(52, 8, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(53, 9, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(54, 9, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(55, 9, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(56, 10, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(57, 10, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(58, 11, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(59, 11, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(60, 11, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(61, 12, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(62, 12, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(63, 13, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(64, 13, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(65, 13, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(66, 14, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(67, 14, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(68, 14, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(69, 15, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(70, 15, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(71, 16, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(72, 16, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(73, 16, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(74, 17, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(75, 17, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(76, 18, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(77, 18, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(78, 18, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(79, 19, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(80, 19, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(81, 19, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(82, 20, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(83, 20, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(84, 21, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(85, 22, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(86, 23, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(87, 23, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(88, 23, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(89, 24, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 2, 698.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(90, 24, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 2, 398.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(91, 24, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(92, 25, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(93, 25, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(94, 26, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(95, 27, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(96, 27, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(97, 27, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 2, 358.00, '2025-10-04 16:40:28', NULL, NULL, '2025-10-04 16:40:28'),
(100, 31, 26, 'Floral Drop Statement Earrings', 179.00, NULL, NULL, NULL, 1, 179.00, '2025-10-05 05:26:54', NULL, NULL, '2025-10-05 05:26:54'),
(101, 32, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-05 05:35:36', NULL, NULL, '2025-10-05 05:35:36'),
(102, 33, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-05 12:35:51', NULL, NULL, '2025-10-05 12:35:51'),
(103, 34, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-05 12:41:13', NULL, NULL, '2025-10-05 12:41:13'),
(104, 35, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-05 12:43:05', NULL, NULL, '2025-10-05 12:43:05'),
(105, 36, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-05 12:44:09', NULL, NULL, '2025-10-05 12:44:09'),
(106, 37, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-05 12:46:16', NULL, NULL, '2025-10-05 12:46:16'),
(107, 38, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-05 12:56:22', NULL, NULL, '2025-10-05 12:56:22'),
(108, 39, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-05 12:59:57', NULL, NULL, '2025-10-05 12:59:57'),
(109, 40, 25, 'Sparkle Textured Rose Gold Earrings', 199.00, NULL, NULL, NULL, 1, 199.00, '2025-10-05 13:07:34', NULL, NULL, '2025-10-05 13:07:34'),
(110, 41, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-07 03:24:09', NULL, NULL, '2025-10-07 03:24:09'),
(111, 42, 24, 'Sparkling Pave Heart Stud Earrings', 349.00, NULL, NULL, NULL, 1, 349.00, '2025-10-07 04:55:17', NULL, NULL, '2025-10-07 04:55:17'),
(112, 43, 53, 'Pearl and Marble Geometric Drop Earrings', 99.00, NULL, NULL, NULL, 1, 99.00, '2025-10-07 05:20:19', NULL, NULL, '2025-10-07 05:20:19'),
(113, 44, 53, 'Pearl and Marble Geometric Drop Earrings', 99.00, NULL, NULL, NULL, 1, 99.00, '2025-10-07 05:22:20', NULL, NULL, '2025-10-07 05:22:20'),
(114, 45, 63, 'Celebrity wear flower Necklace and Earring Set', 249.00, NULL, NULL, NULL, 1, 249.00, '2025-10-07 05:32:01', NULL, NULL, '2025-10-07 05:32:01'),
(115, 46, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:16:15', NULL, NULL, '2025-10-11 03:16:15'),
(116, 47, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:18:34', NULL, NULL, '2025-10-11 03:18:34'),
(117, 48, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:22:41', NULL, NULL, '2025-10-11 03:22:41'),
(118, 49, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:24:19', NULL, NULL, '2025-10-11 03:24:19'),
(119, 50, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:24:27', NULL, NULL, '2025-10-11 03:24:27'),
(120, 51, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:24:39', NULL, NULL, '2025-10-11 03:24:39'),
(121, 52, 66, 'Rose Gold Ornate Necklace Set', 749.00, NULL, NULL, NULL, 1, 749.00, '2025-10-11 03:26:11', NULL, NULL, '2025-10-11 03:26:11'),
(122, 53, 79, 'sampleee', 200.00, NULL, NULL, NULL, 1, 200.00, '2025-10-11 03:28:38', NULL, NULL, '2025-10-11 03:28:38'),
(123, 54, 60, 'Luxury American Diamond Set', 1999.00, NULL, NULL, NULL, 1, 1999.00, '2025-10-11 05:22:30', NULL, NULL, '2025-10-11 05:22:30');
...
(80, 'test one new', 'test-one-new', '', '', 2, NULL, 1000.00, 2000.00, 'SKU-1762491768414-987', '1234', 0, NULL, NULL, NULL, NULL, 'http://localhost:5000/uploads/products/images-1762491768407-225323011.jpg', NULL, 0, 'none', 1, '2025-11-07 05:02:48', '2025-11-07 05:02:48', 50, NULL, NULL, NULL);
...
(36, 80, 'http://localhost:5000/uploads/products/images-1762491768407-225323011.jpg', 1, 0, '2025-11-07 05:02:48'),
(37, 80, 'http://localhost:5000/uploads/products/images-1762491768410-946839395.jpg', 0, 1, '2025-11-07 05:02:48');
...
('20251011180826-create-users-table.js'),
('20251011180850-create-users-table.js'),
('20251011180853-create-categories-table.js'),
('20251011180856-create-company-settings-table.js'),
('20251011180858-create-site-settings-table.js'),
('20251011180900-create-complete-database.js'),
('20251011180901-create-warehouses-table.js'),
('20251011180910-create-categories-table.js'),
('20251026000000-create-instagram-posts-table.js'),
('20251111120000-create-visitor-stats-table.js'),
('20251111123000-align-special-offer-types.js');
...
CREATE TABLE `special_offers` (
  ...
  `title` varchar(255) NOT NULL,
  `description` text DEFAULT NULL,
  `offer_type` enum('percentage','fixed_amount','buy_x_get_y','minimum_purchase','referral','flash_sale','new_arrival','discount_percentage','discount_fixed','free_shipping') NOT NULL DEFAULT 'percentage',
...
(5, 'New Offer', 'New Offer new pricess', '', NULL, 2000.00, 0.00, 'percentage', 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '🎁', '#FF6B6B', '#F5F5DC', NULL, 'Shop Now', '#FFB6C1', '#2C2C2C', NULL, NULL, NULL, 1, 0, NULL, NULL, '2025-11-09 02:54:13', '2025-11-09 02:54:13', 10, NULL, NULL, NULL, 0, NULL, '2025-11-01 00:00:00', '2026-02-28 00:00:00', '/products', NULL, 0, 0),
(6, 'new offer', 'new offer new price', '', NULL, 2000.00, 0.00, 'percentage', 0.00, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, '🎁', '#FF6B6B', '#F5F5DC', NULL, 'Shop Now', '#FFB6C1', '#2C2C2C', NULL, NULL, NULL, 1, 0, NULL, NULL, '2025-11-09 03:25:32', '2025-11-09 06:59:14', 10, NULL, NULL, NULL, 0, NULL, '2025-11-01 00:00:00', '2025-12-31 00:00:00', '/products?category=earrings', NULL, 0, 0);
...
INSERT INTO `stock_levels` (`id`, `product_id`, `warehouse_id`, `current_stock`, `reserved_stock`, `min_stock_level`, `max_stock_level`, `reorder_point`, `last_updated`, `created_at`) VALUES
(5, 24, 1, 50, 0, 10, 100, 20, '2025-10-05 04:39:50', '2025-10-05 04:39:50'),
(6, 24, 2, 50, 0, 10, 100, 20, '2025-10-05 04:39:50', '2025-10-05 04:39:50'),
(7, 25, 1, 50, 0, 10, 100, 20, '2025-10-05 04:39:50', '2025-10-05 04:39:50'),
(8, 25, 2, 50, 0, 10, 100, 20, '2025-10-05 04:39:50', '2025-10-05 04:39:50'),
(9, 26, 1, 50, 0, 10, 100, 20, '2025-10-05 04:39:50', '2025-10-05 04:39:50'),
(10, 26, 2, 50, 0, 10, 100, 20, '2025-10-05 04:39:50', '2025-10-05 04:39:50');
...
(5, 'test', 'admin@erpone.com', '$2a$12$s7l2KS1/yhJM9UbH8bTuiuPqzNkOHXp38BtfZwCjRVe3JgGGuflwG', '8585858585', NULL, NULL, NULL, NULL, 'user', 1, '2025-11-16 08:52:34', '2025-11-16 08:52:34'),
(6, 'test', 'test@gmail.com', '$2a$12$OsUxVQmJ8kRoxM2MyVF8O.iyGgpq73JrtK/6EQZThMkiXEsCYND8S', '5252525252', NULL, NULL, NULL, NULL, 'user', 1, '2025-11-16 09:00:34', '2025-11-16 09:00:34');
...
CREATE TABLE `visitor_stats` (
  ...
  `today_visitors` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `last_reset_at` datetime DEFAULT NULL COMMENT 'Tracks when the daily counter was last reset',
  `last_visited_at` datetime DEFAULT NULL,
  `last_visitor_ip` varchar(45) DEFAULT NULL COMMENT 'Stores last visitor IP (supports IPv6)',
  `created_at` datetime NOT NULL DEFAULT current_timestamp(),
  `updated_at` datetime NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `visitor_stats` (`id`, `total_visitors`, `today_visitors`, `last_reset_at`, `last_visited_at`, `last_visitor_ip`, `created_at`, `updated_at`) VALUES
(1, 4, 4, '2025-11-18 17:44:11', '2025-11-18 17:44:12', '::1', '2025-11-18 17:44:11', '2025-11-18 17:44:12');
...
ALTER TABLE `contact_responses`
  ...
  ADD KEY `idx_response_date` (`response_date`);
...
--
-- Indexes for table `contract_analytics`
--
ALTER TABLE `contract_analytics`
  ADD PRIMARY KEY (`id`),
  ADD KEY `contract_id` (`contract_id`);

--
-- Indexes for table `contract_reminders`
--
...
ALTER TABLE `instagram_posts`
  ADD PRIMARY KEY (`id`),
  ADD KEY `instagram_posts_instagram_id` (`instagram_id`),
  ADD KEY `instagram_posts_status` (`status`),
  ADD KEY `instagram_posts_post_type` (`post_type`),
  ADD KEY `instagram_posts_is_shoppable` (`is_shoppable`),
  ADD KEY `instagram_posts_created_at` (`created_at`);
...
ALTER TABLE `low_stock_alerts`
  ...
  ADD KEY `idx_low_stock_alerts_unresolved` (`is_resolved`,`created_at`);
...
--
-- Indexes for table `partner_analytics`
--
...
--
-- Indexes for table `partner_inventory_sharing`
--
ALTER TABLE `partner_inventory_sharing`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `unique_partner_product` (`partner_id`,`product_id`),
  ADD KEY `product_id` (`product_id`);
...
--
-- Indexes for table `partner_storefronts`
--
ALTER TABLE `partner_storefronts`
  ADD PRIMARY KEY (`id`),
  ADD UNIQUE KEY `subdomain` (`subdomain`),
  ADD KEY `partner_id` (`partner_id`);

--
-- Indexes for table `partner_themes`
--
ALTER TABLE `partner_themes`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `partner_widgets`
--
ALTER TABLE `partner_widgets`
  ADD PRIMARY KEY (`id`);
...
ALTER TABLE `product_colors`
  ...
  ADD KEY `idx_product_colors_active` (`is_active`);
...
ALTER TABLE `stock_levels`
  ...
  ADD KEY `idx_stock_levels_product` (`product_id`),
  ADD KEY `idx_stock_levels_warehouse` (`warehouse_id`);
...
ALTER TABLE `stock_movements`
  ...
  ADD KEY `idx_stock_movements_warehouse` (`warehouse_id`),
...
ALTER TABLE `visitor_stats`
  ADD PRIMARY KEY (`id`),
  ADD KEY `visitor_stats_last_reset_at` (`last_reset_at`),
  ADD KEY `visitor_stats_last_visited_at` (`last_visited_at`);
...
--
-- AUTO_INCREMENT for table `contract_analytics`
--
ALTER TABLE `contract_analytics`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `contract_reminders`
--
ALTER TABLE `contract_reminders`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
-- AUTO_INCREMENT for table `partner_analytics`
--
ALTER TABLE `partner_analytics`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `partner_inventory_sharing`
--
ALTER TABLE `partner_inventory_sharing`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `partner_storefronts`
--
ALTER TABLE `partner_storefronts`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `partner_themes`
--
ALTER TABLE `partner_themes`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `partner_widgets`
--
ALTER TABLE `partner_widgets`
...
--
ALTER TABLE `chat_sessions`
  ADD CONSTRAINT `chat_sessions_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `contact_responses`
--
ALTER TABLE `contact_responses`
  ADD CONSTRAINT `contact_responses_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `contracts`
--
ALTER TABLE `contracts`
  ADD CONSTRAINT `contracts_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `contracts_ibfk_2` FOREIGN KEY (`template_id`) REFERENCES `contract_templates` (`id`) ON DELETE SET NULL,
  ADD CONSTRAINT `contracts_ibfk_3` FOREIGN KEY (`created_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `contract_analytics`
--
ALTER TABLE `contract_analytics`
  ADD CONSTRAINT `contract_analytics_ibfk_1` FOREIGN KEY (`contract_id`) REFERENCES `contracts` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `contract_reminders`
--
ALTER TABLE `contract_reminders`
  ADD CONSTRAINT `contract_reminders_ibfk_1` FOREIGN KEY (`contract_id`) REFERENCES `contracts` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `contract_renewals`
--
ALTER TABLE `contract_renewals`
  ADD CONSTRAINT `contract_renewals_ibfk_1` FOREIGN KEY (`contract_id`) REFERENCES `contracts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `contract_renewals_ibfk_2` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `contract_signatures`
  ...
  ADD CONSTRAINT `contract_signatures_ibfk_2` FOREIGN KEY (`signer_id`) REFERENCES `users` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `low_stock_alerts`
  ...
  ADD CONSTRAINT `low_stock_alerts_ibfk_2` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `low_stock_alerts_ibfk_3` FOREIGN KEY (`resolved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `notifications`
--
ALTER TABLE `notifications`
  ADD CONSTRAINT `notifications_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `notifications_ibfk_2` FOREIGN KEY (`ticket_id`) REFERENCES `support_tickets` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `notifications_ibfk_3` FOREIGN KEY (`chat_session_id`) REFERENCES `chat_sessions` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `partner_analytics`
--
ALTER TABLE `partner_analytics`
  ADD CONSTRAINT `partner_analytics_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE CASCADE;

--
-- Constraints for table `partner_inventory_sharing`
--
ALTER TABLE `partner_inventory_sharing`
  ADD CONSTRAINT `partner_inventory_sharing_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `partner_inventory_sharing_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE;
...
--
-- Constraints for table `partner_storefronts`
--
ALTER TABLE `partner_storefronts`
  ADD CONSTRAINT `partner_storefronts_ibfk_1` FOREIGN KEY (`partner_id`) REFERENCES `partners` (`id`) ON DELETE CASCADE;
...
ALTER TABLE `stock_adjustments`
  ...
  ADD CONSTRAINT `stock_adjustments_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `stock_adjustments_ibfk_4` FOREIGN KEY (`approved_by`) REFERENCES `users` (`id`) ON DELETE SET NULL;

--
-- Constraints for table `stock_levels`
--
ALTER TABLE `stock_levels`
  ADD CONSTRAINT `stock_levels_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `stock_levels_ibfk_2` FOREIGN KEY (`warehouse_id`) REFERENCES `warehouses` (`id`) ON DELETE CASCADE;
...
--
ALTER TABLE `support_tickets`
  ADD CONSTRAINT `support_tickets_ibfk_1` FOREIGN KEY (`contact_id`) REFERENCES `contacts` (`id`) ON DELETE SET NULL;
...
ALTER TABLE `wishlists`
  ...
  ADD CONSTRAINT `wishlists_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`) ON DELETE NO ACTION ON UPDATE CASCADE;
COMMIT;
