...
-- Generated: 2025-10-11 (Updated with all migrations)
-- Total Tables: 45+ (includes all migrations)
-- 
-- This file contains:
-- 1. Complete database schema with all tables
-- 2. All data inserts
-- 3. All migration scripts (offer_id, discounts, contacts, etc.)
--
-- IMPORTANT NOTES:
-- - MySQL 5.7.4+ required for "IF NOT EXISTS" in ALTER TABLE
-- - For older MySQL versions, remove IF NOT EXISTS clauses
-- - Run this file on a fresh database or adjust existing tables
...
INSERT IGNORE INTO `banners` (`id`, `title`, `subtitle`, `image`, `link_url`, `button_text`, `is_active`, `sort_order`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `categories` (`id`, `name`, `slug`, `description`, `image`, `is_active`, `sort_order`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `category_icons` (`id`, `category_slug`, `category_name`, `subtitle`, `icon_type`, `icon_value`, `icon_color`, `background_color`, `text_color`, `link_url`, `is_active`, `sort_order`, `created_at`, `updated_at`) VALUES
...
-- (Moved before chat_sessions to fix foreign key constraint)
--
...
INSERT IGNORE INTO `contacts` (`id`, `name`, `email`, `phone`, `subject`, `message`, `type`, `status`, `priority`, `source`, `ip_address`, `user_agent`, `assigned_to`, `response`, `response_date`, `tags`, `custom_fields`, `created_at`, `updated_at`) VALUES
...
-- (Moved before chat_sessions since it also references contacts)
--
...
INSERT IGNORE INTO `company_settings` (`id`, `setting_key`, `setting_value`, `setting_type`, `description`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `coupon_campaigns` (`id`, `name`, `description`, `target_audience`, `start_date`, `end_date`, `is_active`, `total_budget`, `used_budget`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `coupons` (`id`, `code`, `name`, `description`, `type`, `value`, `min_order_amount`, `max_discount_amount`, `usage_limit`, `usage_count`, `user_limit`, `is_active`, `start_date`, `end_date`, `applicable_products`, `applicable_categories`, `applicable_users`, `campaign_id`, `qr_code_url`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `invoice_items` (`id`, `invoice_id`, `product_id`, `product_name`, `product_sku`, `hsn_sac`, `quantity`, `unit_price`, `discount_percentage`, `discount_amount`, `taxable_amount`, `cgst_percentage`, `cgst_amount`, `sgst_percentage`, `sgst_amount`, `total_amount`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `invoices` (`id`, `invoice_number`, `order_id`, `customer_id`, `invoice_date`, `due_date`, `subtotal`, `tax_amount`, `shipping_amount`, `discount_amount`, `total_amount`, `currency`, `payment_status`, `payment_method`, `payment_date`, `notes`, `terms_conditions`, `pdf_path`, `email_sent`, `email_sent_at`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `order_items` (`id`, `order_id`, `product_id`, `product_name`, `product_price`, `quantity`, `total_price`, `created_at`, `product_image`, `product_sku`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `partner_inventory_sharing` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `partner_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
...
INSERT IGNORE INTO `partner_storefronts` (`id`, `partner_id`, `subdomain`, `custom_domain`, `store_name`, `store_description`, `logo_url`, `favicon_url`, `theme_config`, `layout_config`, `featured_sections`, `widgets_config`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `partner_themes` (`id`, `name`, `description`, `theme_config`, `preview_image`, `is_default`, `is_active`, `created_at`, `updated_at`) VALUES
...
CREATE TABLE IF NOT EXISTS `partner_widgets` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(255) NOT NULL,
...
INSERT IGNORE INTO `partner_widgets` (`id`, `name`, `type`, `config`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `partners` (`id`, `name`, `email`, `phone`, `business`, `partnership_type`, `experience`, `documents`, `status`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `product_images` (`id`, `product_id`, `image_url`, `is_primary`, `sort_order`, `created_at`) VALUES
...
INSERT IGNORE INTO `products` (`id`, `name`, `slug`, `description`, `short_description`, `category_id`, `subcategory_id`, `price`, `original_price`, `sku`, `hsn_sac`, `stock_quantity`, `weight`, `material`, `color`, `size`, `primary_image`, `images`, `is_featured`, `homepage_section`, `is_active`, `created_at`, `updated_at`, `discount_percentage`, `dimensions`, `meta_title`, `meta_description`) VALUES
...
INSERT IGNORE INTO `promotional_banners` (`id`, `text`, `background_color`, `text_color`, `is_active`, `sort_order`, `display_duration`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `promotional_offers` (`id`, `title`, `description`, `offer_type`, `discount_value`, `discount_type`, `minimum_amount`, `maximum_discount`, `buy_quantity`, `get_quantity`, `icon`, `background_color`, `text_color`, `button_color`, `is_active`, `sort_order`, `starts_at`, `expires_at`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `site_settings` (`id`, `setting_key`, `setting_value`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `stock_levels` (`id`, `product_id`, `warehouse_id`, `current_stock`, `reserved_stock`, `available_stock`, `min_stock_level`, `max_stock_level`, `reorder_point`, `last_updated`, `created_at`) VALUES
...
INSERT IGNORE INTO `subcategories` (`id`, `category_id`, `name`, `slug`, `description`, `image`, `sort_order`, `is_active`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `support_tickets` (`id`, `ticket_number`, `contact_id`, `title`, `description`, `category`, `status`, `priority`, `assigned_to`, `customer_id`, `order_id`, `attachments`, `resolution`, `resolved_at`, `created_at`, `updated_at`) VALUES
...
INSERT IGNORE INTO `users` (`id`, `name`, `email`, `password`, `phone`, `address`, `city`, `state`, `pincode`, `role`, `is_active`, `created_at`, `updated_at`) VALUES
...
-- (Moved here after users table to fix foreign key constraints)
--
...
INSERT IGNORE INTO `contract_templates` (`id`, `name`, `description`, `template_type`, `content`, `variables`, `is_active`, `created_by`, `created_at`, `updated_at`) VALUES
...
-- (Moved here after users, partners, and contract_templates to fix foreign key constraints)
--
...
INSERT IGNORE INTO `contracts` (`id`, `contract_number`, `partner_id`, `template_id`, `title`, `description`, `contract_type`, `status`, `start_date`, `end_date`, `renewal_date`, `contract_value`, `terms_and_conditions`, `custom_fields`, `document_path`, `original_filename`, `file_size`, `mime_type`, `created_by`, `created_at`, `updated_at`) VALUES
...
-- (Moved here after contracts table to fix foreign key constraints)
--
...
INSERT IGNORE INTO `contract_analytics` (`id`, `contract_id`, `event_type`, `event_data`, `ip_address`, `user_agent`, `created_at`) VALUES
...
INSERT IGNORE INTO `contract_reminders` (`id`, `contract_id`, `reminder_type`, `reminder_date`, `message`, `is_sent`, `sent_at`, `sent_to_email`, `created_at`) VALUES
...
INSERT IGNORE INTO `contract_signatures` (`id`, `contract_id`, `signer_type`, `signer_id`, `signer_name`, `signer_email`, `signature_data`, `signature_image_path`, `ip_address`, `user_agent`, `signed_at`) VALUES
...
INSERT IGNORE INTO `warehouses` (`id`, `name`, `code`, `address`, `city`, `state`, `pincode`, `phone`, `email`, `manager_name`, `is_active`, `created_at`, `updated_at`) VALUES
...
-- --------------------------------------------------------
-- MIGRATIONS - Apply these after initial database setup
-- --------------------------------------------------------

-- Migration: Add offer_id column to orders table
-- This allows orders to reference special offers applied
ALTER TABLE `orders` 
ADD COLUMN IF NOT EXISTS `offer_id` INT(11) DEFAULT NULL COMMENT 'Special offer ID if this order used a special offer' AFTER `razorpay_order_id`,
ADD KEY IF NOT EXISTS `idx_offer_id` (`offer_id`);

-- Add foreign key constraint if special_offers table exists and constraint doesn't already exist
SET @exist_table := (SELECT COUNT(*) FROM information_schema.tables WHERE table_schema = DATABASE() AND table_name = 'special_offers');
SET @exist_constraint := (SELECT COUNT(*) FROM information_schema.table_constraints WHERE table_schema = DATABASE() AND table_name = 'orders' AND constraint_name = 'orders_ibfk_offer');
SET @sqlstmt := IF(@exist_table > 0 AND @exist_constraint = 0, 
  'ALTER TABLE `orders` ADD CONSTRAINT `orders_ibfk_offer` FOREIGN KEY (`offer_id`) REFERENCES `special_offers` (`id`) ON DELETE SET NULL',
  'SELECT "Constraint already exists or special_offers table does not exist, skipping" AS message');
...
ADD COLUMN IF NOT EXISTS `offer_type` ENUM('percentage', 'fixed_amount', 'buy_x_get_y', 'minimum_purchase', 'referral') NOT NULL DEFAULT 'percentage' COMMENT 'Type of offer' AFTER `description`,
ADD COLUMN IF NOT EXISTS `discount_amount` DECIMAL(10,2) DEFAULT NULL COMMENT 'Fixed discount amount (for fixed_amount type)' AFTER `offer_type`,
ADD COLUMN IF NOT EXISTS `minimum_purchase_amount` DECIMAL(10,2) DEFAULT NULL COMMENT 'Minimum order amount required for offer' AFTER `discount_amount`,
ADD COLUMN IF NOT EXISTS `buy_quantity` INT(11) DEFAULT NULL COMMENT 'Buy quantity for BOGO offers (e.g., buy 2)' AFTER `minimum_purchase_amount`,
ADD COLUMN IF NOT EXISTS `get_quantity` INT(11) DEFAULT NULL COMMENT 'Get quantity for BOGO offers (e.g., get 1)' AFTER `buy_quantity`,
ADD COLUMN IF NOT EXISTS `product_ids` TEXT DEFAULT NULL COMMENT 'Comma-separated product IDs (NULL for all products)' AFTER `get_quantity`,
ADD COLUMN IF NOT EXISTS `category_ids` TEXT DEFAULT NULL COMMENT 'Comma-separated category IDs' AFTER `product_ids`,
ADD COLUMN IF NOT EXISTS `referral_code` VARCHAR(50) DEFAULT NULL COMMENT 'Referral code for referral offers' AFTER `category_ids`,
ADD COLUMN IF NOT EXISTS `max_discount_amount` DECIMAL(10,2) DEFAULT NULL COMMENT 'Maximum discount amount for percentage offers' AFTER `referral_code`,
ADD COLUMN IF NOT EXISTS `priority` INT(11) NOT NULL DEFAULT 0 COMMENT 'Offer priority (higher = applied first if multiple eligible)' AFTER `max_discount_amount`,
ADD COLUMN IF NOT EXISTS `stackable` TINYINT(1) NOT NULL DEFAULT 0 COMMENT 'Can this offer be combined with others' AFTER `priority`;

-- Update existing offers to have type 'percentage' if they have discount_percentage
-- Note: This update is skipped if discount_percentage column doesn't exist
-- The column may not exist in fresh installations
-- UPDATE `special_offers`
-- SET `offer_type` = 'percentage'
-- WHERE EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = DATABASE() AND table_name = 'special_offers' AND column_name = 'discount_percentage')
...
ADD COLUMN IF NOT EXISTS `discounted_quantity` INT(11) DEFAULT NULL COMMENT 'Number of units that received discount' AFTER `product_price`,
ADD COLUMN IF NOT EXISTS `discount_per_unit` DECIMAL(10,2) DEFAULT NULL COMMENT 'Discount amount per unit' AFTER `discounted_quantity`,
ADD COLUMN IF NOT EXISTS `discount_percentage` DECIMAL(5,2) DEFAULT NULL COMMENT 'Discount percentage applied (e.g., 50 for 50% off)' AFTER `discount_per_unit`;
